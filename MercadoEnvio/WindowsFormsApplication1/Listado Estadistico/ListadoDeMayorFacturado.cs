...
{
    public partial class frmListadoDeMayorFacturado : Form
    {
        Conexion conn;
        SqlDataAdapter da;
        public frmListadoDeMayorFacturado(int trimestre, int anio)
        {
            InitializeComponent();
        ...
        public void getData(int trimestref, int aniof) {
            ...
            String cmd = "ADIOS_TERCER_ANIO.vendedoresConMayorMontoFacturadoPorTrimestreAnio";
            ...
            DataTable tablaListado = new DataTable("Mayor_monto_facturado");
